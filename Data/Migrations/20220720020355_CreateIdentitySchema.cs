    ...
    public partial class CreateIdentitySchema : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ImageSlideShow", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Project = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "ProjectImageModelProjectModel",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProjectImageModelProjectModel", x => new { x.ImagesId, x.ProjectsId });
                    table.ForeignKey(
                        name: "FK_ProjectImageModelProjectModel_Project_ProjectsId",
                        column: x => x.ProjectsId,
                        principalTable: "Project",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProjectImageModelProjectModel_ProjectImage_ImagesId",
                        column: x => x.ImagesId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectImageModelProjectModel_ProjectsId",
                table: "ProjectImageModelProjectModel",
                column: "ProjectsId");
        }
